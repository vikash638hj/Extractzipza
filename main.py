...
       "𝐇𝐞𝐥𝐥𝐨 ❤️\n\nkrishan \n\n❈ I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File Om Telegram So Basically If You Want To Use Me First Send Me ⟰ [...]
                            
...
    urls_file = 'urls.txt'  # The file containing the list of URLs to download
    if os.path.exists(urls_file):
        asyncio.run(download_files_from_urls(urls_file))
    else:
        print(f"{urls_file} does not exist. Please create a file with URLs to download.")
    asyncio.run(main())